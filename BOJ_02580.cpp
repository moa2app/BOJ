...
typedef struct blank{
	int I=0;
	int J=0;				// struct of blank's position (map[I][J] = 0) 
} BLANK;
void print_sudoku();
int check_sudoku();
void solve(int);

BLANK BK[100];			// BLANK array more than 9*9
int map[9][9];
int blank_count;		//	number of blank
int across[10][10] = { 0, }, down[10][10] = { 0, }, square[10][10] = { 0, };
